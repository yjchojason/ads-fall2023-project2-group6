...
server <- function(input, output) {
  output$disasterPlot <- renderPlot({
    ...
    if (input$analysisType == "Yearly Analysis") {
      ...
      # Calculate monthly counts for the selected year and disaster type
...
```{r}
url <- "/Users/jasoncho/Documents/GitHub/ads-fall2023-project2-group6/data/Disaster_data.csv"

disaster_data <- read.csv(url)

#head(major_disaster_data) 
colnames(disaster_data)
head(disaster_data)
colnames(disaster_data)[24] <- "begin_month"
colnames(disaster_data)
```
