...
- Added an option to select a specific disaster type, including the 'All' option
- Added a slide-bar to select a year more intuitively
- Added an option to check the average duration
- Added a feature to select specific states
